...
lines_interp = ["tmp/ERR_1lev_base-3lev", 
                "tmp/ERR_2lev_base-4lev",
                "tmp/ERR_3lev_base-5lev",
                "tmp/ERR_4lev_base-6lev",
                "tmp/ERR_5lev_base-7lev"]
...
## PRINT OUT
file_out    = "convergence_data_2Levels.dat"
