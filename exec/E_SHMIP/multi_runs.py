...
#####################
# A template script to lunch several suhmo Suite "E" runs 
# User should be at the root of the E_SHMIP folder 
# Usage:
...
for i, pat in enumerate(patterns):
    ...
    os.system("rm pout.* plot005000.2d.hdf5") 
